...
export default function MainPage({session}) {
    ...
    return (
      ...
      <div className="campaign-container">
        ...
        <button className="cta-button" onClick={()=>{router.push('/contact')}}>kontact Us</button>
      </div>
      <div className="info-container">
        <div className="campaign-info">
          ...
          <div className="info-section left">
            <img src="/supercharge_human.jpg" alt="Image 1" className="info-image" />
            <p className="campaign-description">Supercharge Your Marketing Campaigns with AI Optimization</p>
          </div>
          <div className="info-section right">
            <p className="campaign-description">Harness Social Media Sentiments to Craft Compelling Campaign Content!</p>
            <img src="/concept.jpg" alt="Image 2" className="info-image" />
          </div>
          <div className="info-section left">
            <img src="/meme.jpg" alt="Image 3" className="info-image" />
            <p className="campaign-description">Elevate Audience Engagement with the Power of Meme Marketing</p>
          </div>
        </div>
      </div>
      <div className="about-us-box">
        ...
        <p className="about-us-content">
          Collab kart is an initiative from students of IIT Roorkee. We are backed by TIDES IIT Roorkee. We are a group of students who want to transform the marketing world with AI.
        </p>
      </div>
    </div>
    )
